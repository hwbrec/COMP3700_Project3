...
public class StoreManager {
    ...
    public static final String DB_FILE = "H:\\COMP3700_Project2\\Data\\Project2_Database.db";
...
//        StoreManager.getInstance().init();
        ProductServer pServer = new ProductServer();
        CustomerServer cServer = new CustomerServer();
        PurchaseServer purServer = new PurchaseServer();
        Thread pThread = new Thread(pServer);
        Thread cThread = new Thread(cServer);
        Thread purThread = new Thread(purServer);
